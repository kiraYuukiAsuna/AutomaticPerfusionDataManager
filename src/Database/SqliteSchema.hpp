...
public:
    static auto& getDBStorage() {
        ...
        static auto db = make_storage("DataBase.sqlite",
                            make_table("CellTissueInfo",
                                       make_column("id", &CellTissueInfo::id, primary_key().autoincrement()),
                                       make_column("TissueCellID", &CellTissueInfo::TissueCellID, unique()),
                                       make_column("SamplePreparationDate", &CellTissueInfo::SamplePreparationDate),
                                       make_column("SamplePreparationTime", &CellTissueInfo::SamplePreparationTime),
                                       make_column("SamplePreparationStaff", &CellTissueInfo::SamplePreparationStaff),
                                       ...
                                       make_column("DyeConcentration", &CellTissueInfo::DyeConcentration),
                                       make_column("Immunohistochemistry", &CellTissueInfo::Immunohistochemistry),
                                       make_column("IhcCategory", &CellTissueInfo::IhcCategory),
                                       make_column("PrimaryAntibodyConcentration", &CellTissueInfo::PrimaryAntibodyConcentration),
                                       make_column("SecondAntibodyBand", &CellTissueInfo::SecondAntibodyBand),
                                       make_column("DAPIConcentration", &CellTissueInfo::DAPIConcentration),
                                       ...
                                       make_column("CurrentIntensity", &CellTissueInfo::CurrentIntensity),
                                       make_column("PerfusionTimeOn", &CellTissueInfo::PerfusionTimeOn),
                                       make_column("PerfusionTimeOff", &CellTissueInfo::PerfusionTimeOff),
                                       make_column("ExperimentTemperature", &CellTissueInfo::ExperimentTemperature),
                                       make_column("ExperimentHumidity", &CellTissueInfo::ExperimentHumidity),
                                       ...
                                       make_column("FluorescenceResult", &CellTissueInfo::FluorescenceResult)
                                       ),

                                       make_table("CellMapInfo",
                                       make_column("id", &CellMapInfo::id, primary_key().autoincrement()),
                                       ...
                                       //make_column("needleIndexs", &CellMapInfo::needleIndexs)
                                       ),

                                       make_table("CellTrackInfo",
                                       make_column("id", &CellTrackInfo::id, primary_key().autoincrement()),
                                       ...
                                       make_table("NeedleTrackInfo",
                                        make_column("id", &NeedleTrackInfo::id, primary_key().autoincrement()),
                                        ...
                                        make_table("StateTimeDifferenceInfo",
                                         make_column("id", &StateTimeDifferenceInfo::id, primary_key().autoincrement()),
                                         ...
                                         make_column("InjectionDepth", &StateTimeDifferenceInfo::InjectionDepth),
                                         make_column("START", &StateTimeDifferenceInfo::START),
                                         make_column("MOVE_TO_CELL", &StateTimeDifferenceInfo::MOVE_TO_CELL),
                                         make_column("AUTO_CALIBRATE", &StateTimeDifferenceInfo::AUTO_CALIBRATE),
                                         make_column("RETREAT_NEEDLE", &StateTimeDifferenceInfo::RETREAT_NEEDLE),
                                         make_column("FIND_CELL", &StateTimeDifferenceInfo::FIND_CELL),
                                         make_column("LOWER_NEEDLE", &StateTimeDifferenceInfo::LOWER_NEEDLE),
                                         make_column("AXIAL_INJECTCELL", &StateTimeDifferenceInfo::AXIAL_INJECTCELL),
                                         make_column("START_PERFUSE", &StateTimeDifferenceInfo::START_PERFUSE),
                                         make_column("WAIT", &StateTimeDifferenceInfo::WAIT),
                                         make_column("WITHDRAW_NEEDLE", &StateTimeDifferenceInfo::WITHDRAW_NEEDLE),
                                         make_column("LIFT_NEEDLE", &StateTimeDifferenceInfo::LIFT_NEEDLE),
