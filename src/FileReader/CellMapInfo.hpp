...
struct CellMapInfo {
	...
	friend void from_json(const nlohmann::json& jsonObject,
						  CellMapInfo& dataObject) {
		CellMapInfo defaultDataObject;
		dataObject.MapIndex =
			jsonObject.value("MapIndex", defaultDataObject.MapIndex);
		dataObject.MapBeginCordX =
			jsonObject.value("MapBeginCordX", defaultDataObject.MapBeginCordX);
		dataObject.MapBeginCordY =
			jsonObject.value("MapBeginCordY", defaultDataObject.MapBeginCordY);
		dataObject.MapEndCordX =
			jsonObject.value("MapEndCordX", defaultDataObject.MapEndCordX);
		dataObject.MapEndCordY =
			jsonObject.value("MapEndCordY", defaultDataObject.MapEndCordY);
		dataObject.PathIndex =
			jsonObject.value("PathIndex", defaultDataObject.PathIndex);
		dataObject.SurfaceZ =
