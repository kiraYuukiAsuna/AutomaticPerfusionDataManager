...
struct NeedleInfo {
	...
	friend void from_json(const nlohmann::json& jsonObject,
						  NeedleInfo& dataObject) {
		NeedleInfo defaultDataObject;
		dataObject.NeedleName =
			jsonObject.value("NeedleName", defaultDataObject.NeedleName);
		dataObject.NeedleGlobalPositionX = jsonObject.value(
			"NeedleGlobalPositionX", defaultDataObject.NeedleGlobalPositionX);
		dataObject.NeedleGlobalPositionY = jsonObject.value(
			"NeedleGlobalPositionY", defaultDataObject.NeedleGlobalPositionY);
		dataObject.NeedleGlobalPositionZ = jsonObject.value(
			"NeedleGlobalPositionZ", defaultDataObject.NeedleGlobalPositionZ);
		dataObject.NeedlePositionX = jsonObject.value(
			"NeedlePositionX", defaultDataObject.NeedlePositionX);
		dataObject.NeedlePositionY = jsonObject.value(
			"NeedlePositionY", defaultDataObject.NeedlePositionY);
		dataObject.NeedlePositionZ = jsonObject.value(
			"NeedlePositionZ", defaultDataObject.NeedlePositionZ);
		dataObject.Speed = jsonObject.value("Speed", defaultDataObject.Speed);
		dataObject.AngleXY =
			jsonObject.value("AngleXY", defaultDataObject.AngleXY);
		dataObject.AngleA =
			jsonObject.value("AngleA", defaultDataObject.AngleA);
	}
};
