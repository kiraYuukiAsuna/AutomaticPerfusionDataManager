...
struct CellTrackInfo {
    ...
    friend void to_json(nlohmann::json& jsonObject, const CellTrackInfo& dataObject) {
    ...
    friend void from_json(const nlohmann::json& jsonObject, CellTrackInfo& dataObject) {
