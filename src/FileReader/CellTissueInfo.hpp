...
struct CellTissueInfo {
    ...
    friend void to_json(nlohmann::json&jsonObject, const CellTissueInfo&dataObject) {
        ...
        jsonObject["SamplePreparationStaff"] = dataObject.SamplePreparationStaff;
        ...
        jsonObject["PrimaryAntibodyConcentration"] = dataObject.PrimaryAntibodyConcentration;
    ...
    friend void from_json(const nlohmann::json&jsonObject, CellTissueInfo&dataObject) {
        CellTissueInfo defaultDataObject;
        dataObject.TissueCellID = jsonObject.value("TissueCellID", defaultDataObject.TissueCellID);
        dataObject.SamplePreparationDate = jsonObject.value("SamplePreparationDate",
                                                            defaultDataObject.SamplePreparationDate);
        dataObject.SamplePreparationTime = jsonObject.value("SamplePreparationTime",
                                                            defaultDataObject.SamplePreparationTime);
        dataObject.SamplePreparationStaff = jsonObject.value("SamplePreparationStaff",
                                                             defaultDataObject.SamplePreparationStaff);
        dataObject.SliceThickness = jsonObject.value("SliceThickness", defaultDataObject.SliceThickness);
        dataObject.FreshPerfusion = jsonObject.value("FreshPerfusion", defaultDataObject.FreshPerfusion);
        dataObject.Status = jsonObject.value("Status", defaultDataObject.Status);
        dataObject.DyeName = jsonObject.value("DyeName", defaultDataObject.DyeName);
        dataObject.DyeConcentration = jsonObject.value("DyeConcentration", defaultDataObject.DyeConcentration);
        dataObject.Immunohistochemistry = jsonObject.value("Immunohistochemistry",
                                                           defaultDataObject.Immunohistochemistry);
        dataObject.IhcCategory = jsonObject.value("IhcCategory", defaultDataObject.IhcCategory);
        dataObject.PrimaryAntibodyConcentration =
                jsonObject.value("PrimaryAntibodyConcentration", defaultDataObject.PrimaryAntibodyConcentration);
        dataObject.SecondAntibodyBand = jsonObject.value("SecondAntibodyBand", defaultDataObject.SecondAntibodyBand);
        dataObject.DAPIConcentration = jsonObject.value("DAPIConcentration", defaultDataObject.DAPIConcentration);
        dataObject.PerfusionDate = jsonObject.value("PerfusionDate", defaultDataObject.PerfusionDate);
        dataObject.PerfusionTime = jsonObject.value("PerfusionTime", defaultDataObject.PerfusionTime);
        dataObject.AddingTime = jsonObject.value("AddingTime", defaultDataObject.AddingTime);
        dataObject.Depth = jsonObject.value("Depth", defaultDataObject.Depth);
        dataObject.CurrentIntensity = jsonObject.value("CurrentIntensity", defaultDataObject.CurrentIntensity);
        dataObject.PerfusionTimeOn = jsonObject.value("PerfusionTimeOn", defaultDataObject.PerfusionTimeOn);
        dataObject.PerfusionTimeOff = jsonObject.value("PerfusionTimeOff", defaultDataObject.PerfusionTimeOff);
        dataObject.ExperimentTemperature = jsonObject.value("ExperimentTemperature",
                                                            defaultDataObject.ExperimentTemperature);
        dataObject.ExperimentHumidity = jsonObject.value("ExperimentHumidity", defaultDataObject.ExperimentHumidity);
        dataObject.PerfusionUser = jsonObject.value("PerfusionUser", defaultDataObject.PerfusionUser);
        ...
        dataObject.AddingCordX = jsonObject.value("AddingCordX", defaultDataObject.AddingCordX);
        dataObject.AddingCordY = jsonObject.value("AddingCordY", defaultDataObject.AddingCordY);
        dataObject.AddingCordZ = jsonObject.value("AddingCordZ", defaultDataObject.AddingCordZ);
        dataObject.FluorescenceResult = jsonObject.value("FluorescenceResult", defaultDataObject.FluorescenceResult);
    }
};
...
CellTissueInfoList ReadCellTissueListFromFile(const std::string&filePath) {
    ...
    for (int row = 0; row < doc.GetRowCount(); row++) {
        ...
        cellTissueInfo.SamplePreparationStaff = doc.GetCell<std::string>(3, row);
        ...
        cellTissueInfo.PrimaryAntibodyConcentration = doc.GetCell<std::string>(11, row);
        ...
        cellTissueInfo.ExperimentTemperature = doc.GetCell<std::string>(21, row);
